...
2. Sort entries alphabetically and print a checkmark for installed mods or a cross for missing files. When output is not colorized, use V for installed and X for missing.
