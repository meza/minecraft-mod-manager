...
Bare `mmm` shows help. Command help describes the selected command without starting its operation or offering initialization.

## Related guides

- [Command index and shared behavior](README.md)
