...
Version output works without configuration, including in a missing or broken installation. It does not offer initialization, change the installation or update MMM itself. Self-update is outside the port baseline.
