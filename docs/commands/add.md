...
If the mod cannot be found, the platform is invalid, or no compatible file exists, MMM prompts you to adjust the platform and/or project ID. Use `--unattended` to skip prompts and fail fast. Use `--quiet` when you want to suppress non-essential output.
