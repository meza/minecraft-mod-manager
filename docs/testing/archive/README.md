...
These references preserve historical tooling and evidence. Start with the
[testing guide](../README.md) for the active E2E contract.

- [HTTP VCR helper](http-vcr.md): the retired in-process recording reference.
- [Legacy terminal test ledger](legacy-terminal-test-ledger.md): removed tests,
