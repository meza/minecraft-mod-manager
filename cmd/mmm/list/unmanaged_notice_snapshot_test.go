...
func TestListUnmanagedNoticeSnapshotShortHeight(t *testing.T) {
	runListUnmanagedNoticeSnapshot(t, 25)
}

func TestListUnmanagedNoticeSnapshotTallHeight(t *testing.T) {
	runListUnmanagedNoticeSnapshot(t, tallSnapshotRows())
}

func runListUnmanagedNoticeSnapshot(t *testing.T, rows uint16) {
	...
	_, _, err := runList(context.Background(), cmd, meta.ConfigPath, runListOptions{}, listDeps{
		fs:        fs,
