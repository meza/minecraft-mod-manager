...
func runConfigInitPrompt(cmd *cobra.Command, deps listDeps, meta config.Metadata) (confirmed bool, canceled bool, err error) {
	...
	question := i18n.T("cmd.list.confirm_init", nil)
