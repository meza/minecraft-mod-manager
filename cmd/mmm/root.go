...
import (
	...
	pruneCmd "github.com/meza/minecraft-mod-manager/cmd/mmm/prune"
...
func Command() *cobra.Command {
	...
	rootCmd.PersistentFlags().Bool("unattended", false, "Disable prompts and fail fast when required inputs are missing")
