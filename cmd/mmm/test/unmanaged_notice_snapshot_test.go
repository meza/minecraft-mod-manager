...
func TestTestUnmanagedNoticeSnapshotShortHeight(t *testing.T) {
	runTestUnmanagedNoticeSnapshot(t, 25)
}

func TestTestUnmanagedNoticeSnapshotTallHeight(t *testing.T) {
	runTestUnmanagedNoticeSnapshot(t, tallSnapshotRows())
}

func runTestUnmanagedNoticeSnapshot(t *testing.T, rows uint16) {
