...
This package is tested with local `httptest` servers via injected `Doer`s. See the root [verification guidance](../../CONTRIBUTING.md#verification) for required checks and snapshot update instructions.
